...
import asb_dual_arm.tasks.direct.franka_pick.mdp as mdp


MSR_SURGICAL_ASSETS_DIR = "/workspace/isaaclab/source/ASBDualArm/source/asb_dual_arm/asb_dual_arm/assets"
