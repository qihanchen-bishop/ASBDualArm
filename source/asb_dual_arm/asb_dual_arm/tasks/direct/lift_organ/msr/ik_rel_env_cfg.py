...
@configclass
class MSRPSMLiftOrganNeedlewithRopeEnvCfg(joint_pos_env_cfg.MSRPSMLiftOrganNeedlewithRopeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.num_envs = 1024
...
@configclass
class MSRPSMLiftOrganNeedlewithRopeEnvCfg_PLAY(MSRPSMLiftOrganNeedlewithRopeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a smaller scene for play
...
class MSRPSMLiftOrganBlockEnvCfg(joint_pos_env_cfg.MSRPSMLiftOrganBlockEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot_1.init_state.joint_pos = {
            ...
            "psm_roll_Joint": np.pi,
            "psm_pitch_Joint": 0.0,
            "psm_yaw_Joint": 0.0,
            "psm_gripper1_Joint": 0.0,
            "psm_gripper2_Joint": 0.0,
        }
        self.scene.robot_1.init_state.pos = (-0.25, 0.0, 0.0)
        ...
        self.scene.robot_2.init_state.pos = (0.25, 0.0, 0.0)
