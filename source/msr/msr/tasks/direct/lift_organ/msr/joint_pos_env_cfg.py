...
from msr.tasks.direct.lift_organ.lift_organ_env_cfg import LiftOrganEnvCfg
...
organ_usd_path = '/workspace/isaaclab/source/ASBDualArm/source/msr/msr/assets/others/uperc.usd'
