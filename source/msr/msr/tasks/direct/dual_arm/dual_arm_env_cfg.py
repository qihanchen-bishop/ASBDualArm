...
class LiftOrganSceneCfg(InteractiveSceneCfg):
    ...
    plane: AssetBaseCfg | None = None
    deformable_occluder: DeformableObjectCfg | None = None
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        rgb_image: ObsTerm | None = None
        depth_image: ObsTerm | None = None
        semantic_image: ObsTerm | None = None
...
class LiftOrganEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.sim.physx.gpu_max_particle_contacts = 2**20
